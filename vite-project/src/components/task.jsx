...
<button style={{background: value.status == false?"orange":"green", color:"white", border:"none", padding:"5px 10px",fontSize:"18px",borderRadius:"10px", cursor:"pointer"}} onClick={()=>chnagestate(idx)} >{value.status?"completed":"pending"}</button>
</div>
...
<p>{value.priority}</p>
<button style={{background: value.status == false?"orange":"green", color:"white", border:"none", padding:"5px 10px",fontSize:"18px",borderRadius:"10px", cursor:"pointer"}} onClick={()=>chnagestate(idx)} >{value.status?"completed":"pending"}</button>
<button style={{background:"red", color:"white", border:"none", padding:"5px 10px",fontSize:"18px",borderRadius:"10px", cursor:"pointer"}} onClick={()=>deletdata(idx)} >Delete</button>
</div>
